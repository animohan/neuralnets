...
## Exploring the example given in the AI-WorkShop.

### Sample Feed Forward Neural Network
![Neural Net Image](NN1.PNG)

Goal here is to find the change in weights to reduce the output error. I have added one more node to explicitly show the Softmax operations as it is easier to show calculations.
